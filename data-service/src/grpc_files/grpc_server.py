...
def serve():
    ...
    # hyper_pb2_grpc.add_getUserServicer_to_server(getUserServicer(), server)
    # hyper_pb2_grpc.add_updateUsernameServicer_to_server(updateUsernameServicer(), server)
    # hyper_pb2_grpc.add_updateEmailServicer_to_server(updateEmailServicer(), server)
    # hyper_pb2_grpc.add_updateFirstnameServicer_to_server(updateFirstnameServicer(), server)
    # hyper_pb2_grpc.add_updateLastnameServicer_to_server(updateLastnameServicer(), server)
    # hyper_pb2_grpc.add_searchUsersServicer_to_server(searchUsersServicer(), server)
    # hyper_pb2_grpc.add_addUserServicer_to_server(addUserServicer(), server)
    # hyper_pb2_grpc.add_signupServicer_to_server(signupServicer(), server)
    # hyper_pb2_grpc.add_loginServicer_to_server(loginServicer(), server)
